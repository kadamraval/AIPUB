...
import { Sun, Moon, Info, Plus, Calendar, Download, Globe, Filter, ArrowUpDown, LayoutGrid, Table as TableIcon, Check } from "lucide-react"
  ...
  return (
    <header className="h-14 border-b border-divider bg-content1 px-6 flex items-center justify-between sticky top-0 z-20">
      ...
      <div className="flex items-center gap-2">
        ...
        {(pathname.startsWith("/admin/articles") || pathname.startsWith("/admin/workflows") || pathname.startsWith("/admin/sources") || pathname.startsWith("/admin/websites") || pathname.startsWith("/admin/custom-agents")) && (
